...
/**
 * Based on LightOpenID by Mewp.
 * Modified for Rudie On Wheels by Pieter-Jan Speelmans, Rudie Dirkx.
...
#var_dump($uri);
    ...
    {
		$this->log(compact('method', 'url', 'params'));
...
$this->log(compact('server', 'delegate'));
                            if (empty($server)) {
                                return false;
                            }
